...
public class CategoriaDto {
	...
	public CategoriaDto (Produtos produtos) {
	...
	public static List<CategoriaDto> converter(List<Produtos> produtos) {
		 
		return produtos.stream().map(CategoriaDto::new).collect(Collectors.toList());
	}
}
